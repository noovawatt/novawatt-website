      ...
      <div className="mb-16">
        ...
        <div className="text-center">
          ...
          <p className="text-xm font-normal tracking-tight text-black/50 dark:text-white/50 leading-6">
            Our team is ready to handle all your electrical needs, whether for
            your business, events, buildings, or private projects.
          </p>
        </div>
      </div>
      {/* form */}
